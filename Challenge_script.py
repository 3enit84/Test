...
file = open("G:/KFU/JH/Challenge_data.vcf",'r')#VCF_tst.txt      
bedfile = open("G:/KFU/JH/Challenge_data.bed",'w')
...
command = ("perl table_annovar.pl G:/KFU/JH/Challenge_data.bed humandb/ -buildver hg19 -out Challenge_data_anno -remove -protocol refGene,cytoBand,exac03,avsnp147,dbnsfp30a -operation gx,r,f,f,f -nastring . -csvout -polish -xref example/gene_xref.txt")
print(command)
call(command, shell = True)

file = open("G:/KFU/PRGRMS/annovar/Challenge_data_anno.hg19_multianno.txt",'r')#VCF_tst.txt
newfile = open("G:/KFU/JH/Challenge_data_prcssd.txt",'w')
